<template>
  <div
    class="relative min-h-screen flex items-center justify-center overflow-hidden bg-gradient-to-br from-[#0f172a] via-[#1e293b] to-[#0b1120] p-4">
    ...
    <div class="relative w-full max-w-6xl z-10">
      ...
      <!-- Main Glass Card -->
      <div
        class="relative overflow-hidden rounded-3xl bg-gradient-to-br from-slate-900/95 via-slate-800/95 to-slate-900/95 backdrop-blur-xl border border-white/10 shadow-2xl">
        <!-- Top Shimmer Line -->
        <div
        ...
        <div class="relative px-8 pt-8 pb-4 text-center">
          <h1
            class="text-4xl md:text-5xl font-bold bg-gradient-to-r from-white via-cyan-100 to-indigo-200 bg-clip-text text-transparent">
            Join AI Health
          </h1>
        ...
        <div class="relative flex justify-center px-8 pb-6">
          <div class="bg-white/5 backdrop-blur-sm rounded-full p-1.5 flex gap-2 border border-white/10">
            <button v-for="r in ['patient', 'doctor']" :key="r" @click="role = r"
        ...
        <form @submit.prevent="handleSubmit"
          class="relative px-8 pb-8 space-y-6 max-h-[65vh] overflow-y-auto custom-scroll">
          <!-- ========== COMMON FIELDS ========== -->
          <div class="grid grid-cols-1 md:grid-cols-2 gap-x-5 gap-y-4">
            ...
            <div class="input-group">
              <input :type="showPassword ? 'text' : 'password'" v-model="form.password" required class="input"
                placeholder=" ">
          ...
          <div v-if="role === 'doctor'" class="space-y-5 border-t border-white/10 pt-5">
            ...
            <div>
              ...
              <div v-for="(q, idx) in form.doctor.qualification" :key="idx" class="flex flex-wrap gap-2 mb-2">
                ...
                <button type="button" @click="removeQualification(idx)"
                  class="p-2 text-red-400 hover:text-red-300 transition-colors">✕</button>
              </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
              <div>
                ...
                <label
                  class="group relative flex items-center justify-center gap-2 px-4 py-3 rounded-xl bg-white/5 hover:bg-white/10 border border-white/10 cursor-pointer transition-all duration-300">
            ...
            <div>
              ...
              <div class="flex gap-2">
                ...
                <button type="button" @click="addMedicalHistory"
                  class="px-4 rounded-xl bg-cyan-500/20 hover:bg-cyan-500/30 border border-cyan-500/30 text-cyan-300 transition-all">+</button>
              </div>
            </div>
            ...
            <div>
              ...
              <div class="flex gap-2">
                ...
                <button type="button" @click="addAllergy"
                  class="px-4 rounded-xl bg-red-500/20 hover:bg-red-500/30 border border-red-500/30 text-red-300 transition-all">+</button>
              </div>
            </div>
...
const handleSubmit = async () => {
  ...
  try {
    ...
    console.log("Payload apna .... ", payload);
